...
QWidget* LocalWidget::get_widget()
{
    return initalize_widget(username_edit, fullname_edit, emailaddress_edit,
                            password_edit, create_button, cancel_button,
                            admin_checkbox);
}

QWidget* LocalWidget::initalize_widget(QLineEdit *username_edit, QLineEdit *fullname_edit,
                                       QLineEdit *emailaddress_edit, QLineEdit *password_edit,
                                       QPushButton *create_button, QPushButton *cancel_buton,
